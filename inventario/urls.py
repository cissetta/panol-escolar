...
urlpatterns = [
    ...
    # Herramientas
    path("herramientas/",                   views.herramienta_list,    name="herramientas"),
    path("herramientas/nueva/",             views.nueva_herramienta,   name="nueva_herramienta"),
    path("herramientas/<int:pk>/",          views.ver_qr_herramienta,  name="detalle"),
    ...
    path("herramientas/<int:pk>/qr/",       views.qr_herramienta,      name="qr_herramienta"),
    path("herramientas/<int:pk>/ver-qr/",   views.ver_qr_herramienta,  name="ver_qr_herramienta"),

    # Insumos
    path("insumos/",                    views.lista_insumos,      name="insumos"),
    path("insumos/nuevo/",              views.nuevo_insumo,       name="nuevo_insumo"),
    path("insumos/movimiento/",         views.nuevo_movimiento,   name="nuevo_movimiento"),
